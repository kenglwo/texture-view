        ...
        value: function render() {
          ...
          var layout = (0, _d3Cloud.default)()
            ...
            .on("end", function(words) {
              ...
              var gradient_one_two_three = texts
                .append("defs")
                .append("linearGradient")
                .attr("id", "one_two_three");

              gradient_one_two_three
                .append("stop")
                .attr("offset", 0.3)
                .attr("stop-color", "red");
              gradient_one_two_three
                ...
                .style("fill", function(d, i) {
                  switch (colorStyle) {
                    ...
                    case "mono":
                      ...
                      break;
                    case "categorical":
                      if (d.category_big_id_array !== undefined) {
                        let category_num = d.category_big_id_array.length;
                        switch (category_num) {
                          case 1:
                            if (d.category_big_id_array[0] == 1) {
                              return "red";
                            } else if (d.category_big_id_array[0] == 2) {
                              return "green";
                            } else if (d.category_big_id_array[0] == 3) {
                              return "blue";
                            }
                            break;
                          case 2:
                            if (
                              d.category_big_id_array.includes(1) &&
                              d.category_big_id_array.includes(2)
                            ) {
                              return "url(#one_two)";
                            } else if (
                              d.category_big_id_array.includes(1) &&
                              d.category_big_id_array.includes(3)
                            ) {
                              return "url(#one_three)";
                            } else if (
                              d.category_big_id_array.includes(2) &&
                              d.category_big_id_array.includes(3)
                            ) {
                              return "url(#two_three)";
                            }
                            break;
                          case 3:
                            return "url(#one_two_three)";
                          default:
                            return "white";
                        }
                      } else if (d.category_big_id !== undefined) {
